    ...
    return Message(
        ...
        2.Réponse :
            Si la demande est une question (traduction ou une demande d'explication) :
                Fournis une réponse claire avec des explications en français et des exemples pertinents.
                
            Si la demande concerne des demandes d'exercices :
                Propose des exercices basés sur les documents fournis sans les réponses :
                    - Exercices de Reading Comprehension : Basé sur un texte de minimum 10 phrases ANGLAIS que tu dois fournir.
